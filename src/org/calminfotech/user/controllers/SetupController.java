...
public class SetupController {
	...
	public String setPassword(Model model, @PathVariable("code") String code,
		...
		System.out.print("kkkkkkkk" + code);
		...
		if (userActivation.isUsed() == true) {
			alert.setAlert(redirectAttributes, Alert.WARNING,
					"Your activation link has beed used ! Please contact the admin for a new activation link");
			return "redirect:/";
		}
	...
	public String processPassword(
		...
		//use encryption
		user.setPassword(encryptor.encrypt(passwordSetupForm.getPassword()));
	...
	public String processSecurityQuestions(
		...
		if (tester)
		{
			userSecurityQuestionsBo.save(userSecurityQuestions); // Add for new user
		}
