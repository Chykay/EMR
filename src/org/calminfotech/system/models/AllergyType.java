...
public class AllergyType {
	...
	@Column(name = "allergy_type_id", unique = true, nullable = false)
	private Integer allergyTypeId;

	@Column(name = "allergytype_name", nullable = true)
	...
	private Set<AllergyCategory> allergycategory;
	...
	public Set<AllergyCategory> getAllergycategory() {
		return allergycategory;
	}


	public void setAllergycategory(Set<AllergyCategory> allergycategory) {
