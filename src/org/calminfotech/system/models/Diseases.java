...
@Table(name = "Diseases")
@SQLDelete(sql = "UPDATE diseases SET is_deleted = 1 WHERE diseases_id= ?")
//@Where(clause = "is_deleted <> 1")
public class Diseases {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "diseases_id", unique = true, nullable = false)
	private Integer diseasesId;

	@Column(name = "diseases_name", nullable = false)
	...
	public void setDiseasesType(DiseasesType diseasesType) {
		this.diseasesType = diseasesType;
	}

	@ManyToOne
	@JoinColumn(name = "diseasestype_id")
	private DiseasesType diseasesType;
	
	public DiseasesType getDiseasesType() {
		return diseasesType;
	}

	public void setDiseasesTypeId(DiseasesType diseasesType) {
		this.diseasesType = diseasesType;
	}

	@ManyToOne
	@JoinColumn(name = "diseases_category_id")
	private DiseasesCategory diseasesCategory;
...
*/
	...
	public DiseasesCategory getDiseasesCategory() {
		return diseasesCategory;
	}

	public void setDiseasesCategory(DiseasesCategory diseasesCategory) {
