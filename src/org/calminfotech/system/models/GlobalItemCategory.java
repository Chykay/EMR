...
public class GlobalItemCategory {
	...
	private GlobalItemType GlobalitemTypeId;
	...
	public GlobalItemType getGlobalitemTypeId() {
		return GlobalitemTypeId;
	}

	public void setGlobalitemTypeId(GlobalItemType globalitemTypeId) {
		GlobalitemTypeId = globalitemTypeId;
	}
