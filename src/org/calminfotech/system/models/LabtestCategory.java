...
@Table(name = "labtest_category")
@SQLDelete(sql = "UPDATE labtest_category SET is_deleted = 1 WHERE labtest_category_id= ?")
...
public class LabtestCategory {
	...
	private LabtestType labtestTypeId;
	...
	public LabtestType getLabtestTypeId() {
		return labtestTypeId;
	}

	public void setLabtestTypeId(LabtestType labtestTypeId) {
