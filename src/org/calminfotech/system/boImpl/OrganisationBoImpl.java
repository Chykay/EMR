...
public class OrganisationBoImpl implements OrganisationBo {
	...
	public Organisation save(OrganisationForm organisationForm) {
		...
		organisation.setOrgCoy(userIdentity.getOrganisation().getOrgCoy());
		...
		// organisation.setOrganisationCategory(OrganisationCategoryBo.getOrganisationCategoryById(organisationForm.getParentCategoryId()));

		// organisation.setOrganisationType(OrganisationTypeBo.getOrganisationTypeById(organisationForm.getOrganisationTypeId()));
		...
		/*
		 * Set<Role> srole = new HashSet<Role>(); Role role = new Role();
		 * 
		 * role.setOrganisation(organisation); role.setAdmin(true);
		 * role.setRoleDescription("Default Administrator");
		 * role.setRoleName("Default Adinistrator"); role.setCreatedDate(new
		 * Date(System.currentTimeMillis()));
		 * role.setCreatedBy("system@primary.com"); srole.add(role);
