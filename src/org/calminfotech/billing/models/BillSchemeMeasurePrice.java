...
@Table(name = "bill_scheme_measureprice")
// @SQLDelete(sql = "UPDATE bill_scheme SET is_deleted = 1 WHERE id = ?")
// @Where(clause = "is_deleted <> 1")
public class BillSchemeMeasurePrice {
	...
	private GlobalItemUnitofMeasureVw globalitemunitvw;

	public GlobalItemUnitofMeasureVw getGlobalitemunitvw() {
		return globalitemunitvw;
	}

	public void setGlobalitemunit(GlobalItemUnitofMeasureVw globalitemunitvw) {
		this.globalitemunitvw = globalitemunitvw;
	}
