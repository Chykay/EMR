...
@SQLDelete(sql = "UPDATE Staffstatus SET is_deleted = 1 WHERE staffstatus_id = ?")
...
public class Staffstatus {
   ...
   private Date modifiedDate;
	...
	@Column(name = "staffstatus_id", unique = true, nullable = false)
	...
	public void setHmostatus_id(Integer hmostatus_id) {
		this.staffstatus_id = hmostatus_id;
	}
