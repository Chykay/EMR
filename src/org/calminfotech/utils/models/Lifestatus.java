...
public class Lifestatus {
   ...
   private Date modifiedDate;
	...
	public void setLifestatus_id(Integer lifestatus_id) {
	...
	@Column(name = "lifestatus_id", unique = true, nullable = false)
	public Integer getLifestatus_id() {
