...
public class SearchController {
	...
	public String searchblank(Model model, HttpSession session) {
		//List<Patient> plist = this.patientBo.fetchAllByOrganisation(userIdentity.getOrganisation().getId());
	...
	@Layout("layouts/blank")
	public String searchblankpost(Model model, HttpSession session,
		...
		//List patientList = searchBo.searchPatient(searchForm, session);
				List patientList = searchUtilBo.searchPatientwin(patientSearchForm, session);
	...
	@Layout("layouts/blank")
	public String searchblankpostapp(Model model, HttpSession session,
		@ModelAttribute("patientSearch") PatientSearchForm patientSearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
	...
	@Layout("layouts/blank")
	public String searchblankpostapp2(Model model, HttpSession session,
		@ModelAttribute("patientSearch") PatientSearchForm patientSearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
...
AllergySearchForm pf = new AllergySearchForm();
	...
	@Layout("layouts/blank")
	public String searchallergyblankpost(Model model, HttpSession session,
		@ModelAttribute("allergySearch") AllergySearchForm allergySearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
	
	//	List patientList = searchBo.searchPatient(searchForm, session);
				List allergyList = searchUtilBo.searchAllergywin(allergySearchForm, session);
...
//	@Layout("layouts/blank")
//	public String searchpersonnelblankpost(Model model, HttpSession session,
		//@ModelAttribute("personnelSearch") PersonnelSearchForm personnelSearchForm,
		//BindingResult result,RedirectAttributes redirectAttributes) {
	
	//	List patientList = searchBo.searchPatient(searchForm, session);
			//	List personnelList = searchUtilBo.searchPersonnelwin(personnelSearchForm, session);
...
BillingSearchForm pf = new BillingSearchForm();
	...
	@Layout("layouts/blank")
	public String searchbillingitemblankpost(Model model, HttpSession session,
		@ModelAttribute("billingSearch") BillingSearchForm billingitemSearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
	
	//	List patientList = searchBo.searchPatient(searchForm, session);
				List billingitemList = searchUtilBo.searchBillingitemwin(billingitemSearchForm, session);
	...
	@Layout("layouts/blank")
	public String searchblankpostexam(Model model, HttpSession session, 
		@ModelAttribute("examinationSearch") ExaminationSearchForm examinationSearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
		
		
		//List patientList = searchBo.searchPatient(searchForm, session);
				List examinationList = searchUtilBo.searchExaminationwin(examinationSearchForm, session);
	...
	@Layout("layouts/blank")
	public String searchblankpostlab(Model model, HttpSession session, 
		@ModelAttribute("laboratorySearch") LaboratorySearchForm laboratorySearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
		
		
		//List patientList = searchBo.searchPatient(searchForm, session);
				List laboratoryList = searchUtilBo.searchLaboratorywin(laboratorySearchForm, session);
	...
	@Layout("layouts/blank")
	public String searchblankpostdiag(Model model, HttpSession session, 
		@ModelAttribute("diseasesSearch") DiseasesSearchForm diseasesSearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
		
		
		//List patientList = searchBo.searchPatient(searchForm, session);
				List diseasesList = searchUtilBo.searchDiseaseswin(diseasesSearchForm, session);
	...
	@Layout("layouts/blank")
	public String searchblankpostsur(Model model, HttpSession session, 
		@ModelAttribute("surgerySearch") SurgerySearchForm surgerySearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
		
		
		//List patientList = searchBo.searchPatient(searchForm, session);
				List surgeryList = searchUtilBo.searchSurgerywin(surgerySearchForm, session);
	...
	@Layout("layouts/blank")
	public String searchblankpostadm(Model model, HttpSession session, 
		@ModelAttribute("admissionSearch") AdmissionSearchForm admissionSearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
		
		
		//List patientList = searchBo.searchPatient(searchForm, session);
				List admissionList = searchUtilBo.searchAdmissionwin(admissionSearchForm, session);
	...
	@Layout("layouts/blank")
	public String searchinventoryblankpost(Model model, HttpSession session,
		@ModelAttribute("inventorySearch") InventorySearchForm inventorySearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
	
	//	List patientList = searchBo.searchPatient(searchForm, session);
				List inventoryList = searchUtilBo.searchInventorywin(inventorySearchForm, session);
	...
	@Layout("layouts/blank")
	public String searchinventoryblankpostreq(Model model, HttpSession session,
		@ModelAttribute("inventorySearch") InventorySearchForm inventorySearchForm,
		BindingResult result,RedirectAttributes redirectAttributes) {
