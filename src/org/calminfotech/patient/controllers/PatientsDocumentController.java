...
public class PatientsDocumentController {
	...
	public String saveDocument(
		...
		if (patientDocumentForm.getDocument().getSize() > 150000000)

		{

			alert.setAlert(redirectAttributes, Alert.SUCCESS,
					"Image size cannot be more than 150 MB");
		...
		try {
			...
			patientDocument
					.setDescription(patientDocumentForm.getDescription());
	...
	public String confirmDocumentDeleteAction(
		...
		PatientDocument patientDocument = this.patientDocumentBo
				.getPatientDocumentById(patientDocumentForm
		...
		if (null == patientDocument) {
			...
			return "redirect:/patients/documents/"
					+ patientDocumentForm.getPatientDocumentId();
	...
	public String geteditDocument(@PathVariable("id") Integer id, Model model,
		...
		PatientDocument patientdocument = patientDocumentBo
				.getPatientDocumentById(id);
