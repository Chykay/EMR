...
public class HmoPackageItemController {
	...
	public String saveActionItem3(
		...
		if (authorize.isAllowed("HMI001")) {
			...
			HmoPackage hmoPackage = hmoPackageBo.getHmoPackageById(hmoItemForm
					.getHmopackage_id());
			...
			// hmoPackageItem.setBillitem(billitemBo
			// .getBillingitemById(hmoItemForm.getBillingitem_id()));

			hmoPackageItem.setSpendingLimit(hmoItemForm.getSpendingLimit());
			hmoPackageItem.setPeriod(this.periodList.getPeriodById(hmoItemForm
					.getPeriod_id()));
			hmoPackageItem.setPeriodNo(hmoItemForm.getPeriodNo());
			hmoPackageItem.setUseaspercent(hmoItemForm.getUseaspercent());
			hmoPackageItem.setTimeNo(hmoItemForm.getTimeNo());
			hmoPackageItem.setHmostatus(this.hmostatusList
					.getHmostatusById(hmoItemForm.getStatus_id()));
			hmoPackageItem.setDescription(hmoItemForm.getDescription());
			hmoPackageItem.setCreatedBy(userIdentity.getUsername());
			hmoPackageItem.setOrganisation(userIdentity.getOrganisation());
	...
	public String editActionEdititem3(@PathVariable("id") Integer id,
		...
		if (authorize.isAllowed("HMI003")) {
			...
			// hmoItemForm.setBillingitem_id(hmoItem.getBillitem().getId());
			...
			hmoItemForm.setUseaspercent(hmoItemForm.getUseaspercent());
			List<Hmostatus> hmostatus = hmostatusList.fetchAll();
			...
			model.addAttribute("hmostatus", hmostatus);
			model.addAttribute("billitemname", hmoItem.getBillitem().getName());
	...
	public String updateActionEdititem3(
		...
		if (authorize.isAllowed("HMI003")) {
			...
			hmoPackageItem.setHmoPackage(hmoPackage);
			hmoPackageItem.setName(hmoItemForm.getName());
			// hmoPackageItem.setBillitem(billitemBo.getBillingitemById(hmoItemForm.getBillingitem_id()));
