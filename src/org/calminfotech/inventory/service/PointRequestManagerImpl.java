...
public class PointRequestManagerImpl implements PointRequestManagerInterface {
	...
	public PointRequest savePointRequest(RequestForm orderRequestForm) {
		...
		/*
		 * try { if
		 * (this.userIdentity.getStaffregistration().getHrunitcategory() !=
		 * null) {
		 * 
		 * pointRequest.setUnit(this.hrunitcat
		 * .getHrunitCategoryById(this.userIdentity
		 * .getStaffregistration().getHrunitcategory() .getCategoryId()));
		 * System.out.println("I no made error. My unit is real"); } } catch
		 * (Exception e) { System.out.println("I made error. My unit is null");
		 * pointRequest.setUnit(null); }
		 */
		pointRequest.setUnit(userIdentity.getCurrentUnit());
	...
	public List<PointRequest> getPointRequestsTop100(
		...
		return this.orderRequestDaoImpl.getPointRequestsTop100(
				pointRequestSearchForm.getDateOfRequest(),
				pointRequestSearchForm.getSearchCriteria());
	}
	...
	public List<PointRequest> getPointRequestsMakeTop100(
		...
		return this.orderRequestDaoImpl.getPointRequestsMakeTop100(
				pointRequestSearchForm.getDateOfRequest(),
				pointRequestSearchForm.getSearchCriteria());
	}
	...
	public void approvePointLineRequest(int reqLineId, int qtyToApprove)
		...
		this.storeissurelog(pointRequestLine, userIdentity.getUsername(),
				...
				userIdentity.getOrganisation(), "Approved",
	...
	public void disapprovePointRequestLine(PointRequestLine pointRequestLine) {
		...
		this.storeissurelog(pointRequestLine, userIdentity.getUsername(),
				new Date(System.currentTimeMillis()),
				userIdentity.getOrganisation(), "Reverse Approve",
				-pointRequestLine.getQuantityApproved());
	...
	public void issuePointRequestLine(PointRequestLine pointRequestLine,
		...
		try {
			...
			System.out.print("Unknown Wahala");
		}
		...
		this.orderRequestDaoImpl.updatePointRequest(pointRequest);
		System.out.print("this is the point request id "
				+ pointRequestLine.getId());
		...
		displog.setOrganisation(userIdentity.getOrganisation());
	...
	public void revissuePointRequestLine(PointRequestLine pointRequestLine)
		...
		this.storeissurelog(pointRequestLine, userIdentity.getUsername(),
				new Date(System.currentTimeMillis()),
				userIdentity.getOrganisation(), "Reverse Issue",
				-pointRequestLine.getQuantityApproved());
	...
	public void storeissurelog(PointRequestLine request, String createdBy,
			Date createdDate, Organisation organisation, String action,
			Integer qty)

	{
		...
		storeissuelog.setOrganisation(organisation);
